    @extends('admin.layouts.main')
        {{-- content --}}
        @section('content')
        <h1 class="h3 mb-3"><strong>Data</strong> Siswa</h1>
            ...
            <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                <div class="card flex-fill">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ url('pplg/create') }}" class="btn btn-primary">Tambah Siswa</a>
                            </div>
                        </div>
                         @if (session('msg'))
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('pplg/'. $prd -> id .'/edit/') }}" class="text-warning"><i class="align-middle" data-feather="edit"></i> <span class="align-middle"></a>
                                </td>
                            </tr> 
