        ...
        <div class="row">
            <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                         <form action="{{ url('sellers/'. $id = $seller -> id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="mb-3 row">
                                <label for="" class="col-sm-2 col-form-label">Nama Penitip</label>
                                <div class="col-sm-10">
                                <input type="text" name="namapenitip" class="form-control  @error('namapenitip') is-invalid @enderror"  value="{{ $seller->nama_penitip }}" id="">
                                @error('namapenitip')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                <input type="number" name="nomer" class="form-control @error('nomer') is-invalid @enderror" value="{{ $seller->no_telp }}"  id="">
                                @error('nomer')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                </div>
