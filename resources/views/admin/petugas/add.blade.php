                    ...
                    <div class="card-body">
                         <form action="{{ url('user') }}" method="post">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" name="namapetugas" class="form-control  @error('namapetugas') is-invalid @enderror"  value="{{ old('namapetugas') }}" id="">
                                @error('namapetugas')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" name="username" class="form-control  @error('username') is-invalid @enderror"  value="{{ old('username') }}" id="">
                                @error('username')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                </div>
